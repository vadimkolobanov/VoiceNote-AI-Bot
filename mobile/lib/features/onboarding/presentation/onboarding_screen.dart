...
class _SlideLearn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _SlideLayout(
      ...
      title: 'Учи меня тем, что не задача',
      subtitle:
          'Отдельный режим «Расскажи о себе» — для контекста о людях, привычках, вещах. В Хронику не попадает.',
      examples: [
        '«Жена Диана, работает в Сбере. Сын Миша, 4 года»',
        '«Машина Camry 2018, ОСАГО до марта»',
        '«Не люблю кинзу. Аллергия на пенициллин»',
      ],
      footer:
          'Это уходит в память. Я опираюсь на эти факты, когда отвечаю.',
    );
  }
}
