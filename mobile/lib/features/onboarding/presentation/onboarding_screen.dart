...
class _SlideLearn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _SlideLayout(
      ...
      examples: [
        '«Расскажи мне о своих близких — кто они, чем занимаются»',
        '«Поделись привычками — что любишь, как проводишь утро»',
        '«Опиши свои цели на этот год — я буду держать их в фокусе»',
      ],
      footer:
