...
class _SlideLearn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _SlideLayout(
      ...
      title: 'Я учусь под тебя',
      subtitle:
          'Делись тем, что важно — задачи, цели, привычки, контекст работы. Я запоминаю и связываю это, чтобы напоминать к месту и отвечать по существу. Делишься столько, сколько хочешь.',
      examples: [
        '«Сейчас в фокусе запуск нового продукта — держи это в голове»',
        '«По вторникам и четвергам тренировка, не ставь встречи на 19:00»',
        '«Я кофе только до полудня, после — чай»',
      ],
      footer:
          'Эти заметки видишь только ты, в твоём аккаунте. Чем дольше пользуешься — тем точнее я отвечаю. Через пару месяцев работать без меня будет уже неудобно.',
    );
  }
}
